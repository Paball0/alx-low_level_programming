...
#include <string.h>
/**
* _isNum - check for a numerical value
*@num: string a checked
...
/**
* *_memset - function replocates a character to the first number of characters in the string pointed
*@s: initial string
*@b: value to replaced
*@n: n size
*Return: new string
...
/**
* main - gives product of 2 positive numbers
