...
/**
 * print_version - Funtion prints the version of an ELF header.
...
/**
 * print_entry - Function prints the entry point of .h
...
/**
 * main - Function displays the info contained in the
