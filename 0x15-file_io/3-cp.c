...
/**
 * main - Copies the contents of each file
...
/**
 * print_error_1 - Function print the error & closes file descriptor
...
/**
 * print_error - Function print the error & closes file descriptor
 * @msg: Error message to show
 * @opt: Optional arguments
 * @status: Exit status code
 **/
